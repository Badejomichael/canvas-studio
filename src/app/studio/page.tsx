...
const TRAITS: Record<CategoryKey, TraitOption[]> = {
  backgrounds: [
    ...
    { id: "bg2", label: "Black Gradient", filename: "bg2.png" },
    { id: "bg3", label: "Red", filename: "bg3.png" },
  ],
  base: [
  ...
  hair: [{ id: "hair1", label: "Deadlocks", filename: "hair1.png" }],
  outfits: [
  ...
  eyes: [{ id: "eyes1", label: "Blue Eyes", filename: "eyes1.png" }],
  mouth: [{ id: "mouth1", label: "Grin", filename: "mouth1.png" }],
  companion: [
    { id: "pet1", label: "Gold Moyaki", filename: "pet1.png" },
    { id: "pet2", label: "Chog", filename: "pet2.png" },
    { id: "pet3", label: "Chog VR", filename: "pet3.png" },
    { id: "pet4", label: "Mecha Chog", filename: "pet4.png" },
  ],
  accessories: [{ id: "acc1", label: "Bandana", filename: "acc1.png" }],
};
